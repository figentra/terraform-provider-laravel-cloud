...
page_title: "laravelcloud_bucket Resource - laravelcloud"
subcategory: ""
description: |-
  S3-compatible object storage bucket. Mode toggles between private (default) and public.
---

# laravelcloud_bucket (Resource)
